...
def upload_note():
    try:
        ...
        try:
            ...
            print(f"📤 Google Drive filename: {drive_filename}")
            print(f"📁 Path: {course.name}/Semester_{semester}/{subject_name}/{note_type}")
        ...
        print(f"📤 Google Drive file: {drive_filename}")
